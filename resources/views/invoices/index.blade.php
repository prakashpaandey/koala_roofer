                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-50">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors group">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="h-8 w-8 flex-shrink-0 rounded-lg bg-gray-100 flex items-center justify-center text-roofing-blue font-black text-[10px] border border-gray-200">
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center text-secondary-text italic font-medium bg-gray-50/50">No invoices generated yet. Click "Create New Invoice" to start.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
