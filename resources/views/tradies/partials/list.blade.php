...
<div class="grid grid-cols-1 gap-4 md:hidden mb-6">
    @forelse($tradies as $tradie)
        <div class="bg-white rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100/50 p-5 group transition-all duration-500 hover:shadow-[0_20px_40px_rgba(0,0,0,0.06)] hover:-translate-y-1">
            <!-- Top Header Row (Premium Refined) -->
            ...
            <!-- Info Grid (Premium Branded Icons) -->
            <div class="space-y-3 mb-5 px-1">
                <div class="flex items-center">
                    <div class="w-8 h-8 rounded-xl bg-orange-50/80 flex items-center justify-center mr-3 text-construction-orange shadow-sm border border-orange-100/50">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                        </svg>
                    </div>
                    <span class="text-[13px] text-slate-700 font-bold tracking-tight">{{ $tradie->contact_number }}</span>
                </div>
                <div class="flex items-start">
                    <div class="w-8 h-8 rounded-xl bg-blue-50/80 flex items-center justify-center mr-3 text-roofing-blue shadow-sm border border-blue-100/50 flex-shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                        </svg>
                    </div>
                    <span class="text-[11px] text-slate-500 font-medium leading-relaxed mt-0.5 line-clamp-1 truncate pr-2">{{ $tradie->address }}</span>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-3 pt-5 border-t border-slate-50">
                <a href="{{ route('tradies.edit', $tradie) }}" class="flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-roofing-blue to-[#2a4d7a] text-white text-[10px] uppercase font-black rounded-2xl hover:shadow-lg hover:shadow-blue-100 transition-all active:scale-[0.97]">
                ...
                <button 
                    ...
                    class="flex items-center justify-center gap-2 py-3 bg-white text-error-red text-[10px] uppercase font-black rounded-2xl border border-red-100 hover:bg-red-50 transition-all active:scale-[0.97]"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
